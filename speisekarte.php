...
<a class="navbar-brand" href="index.php"><img src="media/Logos/psvbeisl.png" height="50"></a>
  ...
  <li class="nav-item">
    <a class="nav-link active" href="speisekarte.php">Speisekarte</a>
  </li>
  <li class="nav-item">
...
<!-- Ende Hauptmenü  -->
    ...
    <!-- <div class="box_firstline"> -->
        <!-- <div class="infobox_first_top"> -->

        <div class="d-flex justify-content-center mt-5"> 
          <iframe src="uploads/pdf/speisekarte.pdf" width="50%" height="600px"> </iframe>
        </div> 
        <!-- </div> -->
