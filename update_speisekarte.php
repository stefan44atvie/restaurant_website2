<?php 
      ...
      if(isset($_POST["register"])){
        ...
        if(empty($speisekarte)){
          ...
          // $speisekarteError ="Bitte speisekarte einfügen!";
...
<div class="container">
                ...
                <a href='update_speisekarte.php'  class='btn btn-info disabled'>Upload Speisekarte</a>
...
<div class="loginbox opacity_dark50 box_top5 w-50">
        ...
        <div class="container">
            <h1 class="title_hours">Laden Sie hier die aktuelle speisekarte für das PSV-Beisl hoch</h1>
            <?php
              if(isset($errMsg)){
              ?>
            ...
            ?>
                ...
                <form class="w-50" method="POST" action="<?= htmlspecialchars($_SERVER['SCRIPT_NAME'])?>" enctype="multipart/form-data">
                      ...
                      <input type="submit" class="form-control" name="register" value="upload speisekarte">
